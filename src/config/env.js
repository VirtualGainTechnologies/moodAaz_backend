...
module.exports = {
  ...
  SPACE_SECRET_ACCESS_KEY: env("SPACE_SECRET_ACCESS_KEY"),
  PROD_PUBLIC_SPACE_NAME: env("PROD_PUBLIC_SPACE_NAME"),
  TEST_PUBLIC_SPACE_NAME: env("TEST_PUBLIC_SPACE_NAME"),
  S3_TEST_PUBLIC_BASE_URL: env("S3_TEST_PUBLIC_BASE_URL"),
  S3_PROD_PUBLIC_BASE_URL: env("S3_PROD_PUBLIC_BASE_URL"),
